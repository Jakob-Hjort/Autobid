...
public sealed class SetForSaleViewModel : ViewModelBase
{
    ...
    // Kilder til ComboBox'ene (enum-v�rdierne)
    ...
    Vehicle BuildVehicle()
    {
        ...
        var year = Year!.Value;
        // default afh�nger af kategori (bare for UX � dom�neklasserne tjekker selv ranges)
        ...
        else // Personal
        {
            ...
            // S�t trunk kun hvis alle tre v�rdier er udfyldt
