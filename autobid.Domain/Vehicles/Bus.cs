...
public sealed class Bus : HeavyVehicle                  // sealed: ingen videre arv
{
    ...
    public Bus(
        ...
        double engineLiters, bool towHitch, double kmPerLiter, Fuel fuel = default)             // Motorstørrelse + træk-krog
        : base(id, name, km, regNo, year, kmPerLiter, fuel)               // Kald HeavyVehicle-ctor
    {
